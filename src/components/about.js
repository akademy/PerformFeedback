			...
			>
				<View style={{
					...
					>
						...
						<Text style={[styles.paragraph,styles.text]}>
							If you are taking part in a performance you can fill in the details on the "Profile" page any time before or after the performance. You will be guided through the "Performance" pages during the performance. Please only fill in the details on the "Questions" page after you have attended the performance.
						</Text>
